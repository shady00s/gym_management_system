        ...
        Expanded(
          child: Padding(
            ...
            child: Consumer(builder: (key, ref, child) {
              var filterData = ref.watch(filterNewProvider);
              StateController<int> playersListLength =
                  ref.read(newPlayersAddedDurationProviderLength.notifier);
