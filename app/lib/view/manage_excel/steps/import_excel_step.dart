      ...
      child: Column(
        ...
        children: [
          const Padding(
            ...
            child:
                Text("Please add excel file with extension .csv or with .xlsx"),
          ),
          DropTarget(
              onDragDone: (details) {
                setState(() {
                ...
                ExcelFileCubit.get(context).selectFile(PlatformFile(
                    path: details.files[0].path,
                          ...
                          Button(
                              ...
                              onPressed: () async {
                                await FilePicker.platform.pickFiles(
                                  ...
                                  ExcelFileCubit.get(context).selectFile(
                                      PlatformFile(
